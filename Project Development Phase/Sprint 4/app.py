...
sg = sendgrid.SendGridAPIClient("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")
from_email = Email("19z322@psgtech.ac.in")  # Change to your verified sender
